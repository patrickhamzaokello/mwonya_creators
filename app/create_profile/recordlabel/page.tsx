...
export default function CreateNewRecordLabel() {
  ...
  return (
    <div className="bg-background border border-border my-8 mx-auto max-w-7xl">
      <div className="grid md:grid-cols-5 gap-8 bg-background p-4 md:p-8">
        <div className="md:col-span-3 space-y-6">
          <h2 className="text-3xl font-bold text-primary mb-2">Add New Record Label</h2>
          <p className="mb-8 text-muted-foreground font-regular">
            Enter the details of the new record label to add it to the database.
          </p>
