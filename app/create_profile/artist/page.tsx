...
export default function CreateArtistPage() {
  ...
  return (
    <div className="bg-background border border-border my-8 mx-auto max-w-7xl">
      <div className="grid md:grid-cols-5 gap-8">
        <div className="md:col-span-3  p-8">
          <h2 className="text-3xl font-bold text-primary mb-2">Create New Artist</h2>
          <p className="mb-8 text-muted-foreground font-regular">Enter the details of the new artist to save.</p>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          disabled={isPending}
                          className="cursor-pointer file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-primary-foreground hover:file:bg-primary/90"
                          {...rest}
                        />
                      </FormControl>
